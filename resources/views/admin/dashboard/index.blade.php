                    ...
                    <div class="d-flex align-items-end row">
                        ...
                        <div class="col-sm-5 text-center text-sm-left">
                            <div class="card-body pb-0 px-0 px-md-4">
                                <img src="{{ asset('admin-frontend') }}/assets/img/illustrations/man-with-laptop-light.png"
                    ...
                    <div class="col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between">
                                    <div class="avatar flex-shrink-0">
                                        <img src="{{ asset('admin-frontend') }}/assets/img/icons/unicons/paypal.png"
                                            alt="Credit Card" class="rounded" />
                                    </div>
                                    <div class="dropdown">
                        ...
                        <div class="tab-content p-0">
                            <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
                                <div class="d-flex p-4 pt-3">
                                    <div class="avatar flex-shrink-0 me-3">
                                        <img src="{{ asset('admin-frontend') }}/assets/img/icons/unicons/wallet.png"
                                            alt="User" />
                                    </div>
                                    <div>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <ul class="p-0 m-0">
                            ...
                            <li class="d-flex mb-4 pb-1">
                                <div class="avatar flex-shrink-0 me-3">
                                    <img src="{{ asset('admin-frontend') }}/assets/img/icons/unicons/chart.png" alt="User"
                                        class="rounded" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                            ...
                            <li class="d-flex mb-4 pb-1">
                                <div class="avatar flex-shrink-0 me-3">
                                    <img src="{{ asset('admin-frontend') }}/assets/img/icons/unicons/cc-success.png"
                                        alt="User" class="rounded" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                                ...
                                <div class="timeline-event">
                                    ...
                                    <div class="d-flex">
                                        <a href="javascript:void(0)" class="d-flex align-items-center me-3">
                                            <img src="{{ asset('admin-frontend') }}/assets/img/icons/misc/pdf.png"
                                ...
                                <div class="timeline-event">
                                    ...
                                    <div class="d-flex flex-wrap">
                                        <div class="avatar me-3">
                                            <img src="{{ asset('admin-frontend') }}/assets/img/avatars/3.png" alt="Avatar"
                                ...
                                <div class="timeline-event pb-0">
                                    ...
                                    <div class="d-flex align-items-center avatar-group">
                                        <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                            ...
                                            <img src="{{ asset('admin-frontend') }}/assets/img/avatars/5.png" alt="Avatar"
                                                class="rounded-circle" />
                                        </div>
                                        <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                            data-bs-placement="top" title="Marrie Patty">
                                            <img src="{{ asset('admin-frontend') }}/assets/img/avatars/12.png" alt="Avatar"
                                                class="rounded-circle" />
                                        </div>
                                        <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                            data-bs-placement="top" title="Jimmy Jackson">
                                            <img src="{{ asset('admin-frontend') }}/assets/img/avatars/9.png" alt="Avatar"
                                                class="rounded-circle" />
                                        </div>
                                        <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                            data-bs-placement="top" title="Kristine Gill">
                                            <img src="{{ asset('admin-frontend') }}/assets/img/avatars/6.png" alt="Avatar"
                                                class="rounded-circle" />
                                        </div>
                                        <div class="avatar pull-up" data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                            data-bs-placement="top" title="Nelson Wilson">
                                            <img src="{{ asset('admin-frontend') }}/assets/img/avatars/14.png" alt="Avatar"
                                                class="rounded-circle" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <table class="table table-borderless text-nowrap">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin-frontend') }}/assets/img/icons/brands/chrome.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin-frontend') }}/assets/img/icons/brands/safari.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin-frontend') }}/assets/img/icons/brands/firefox.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin-frontend') }}/assets/img/icons/brands/edge.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin-frontend') }}/assets/img/icons/brands/opera.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin-frontend') }}/assets/img/icons/brands/brave.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin-frontend') }}/assets/img/icons/brands/vivaldi.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin-frontend') }}/assets/img/icons/brands/uc.png"
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin-frontend') }}/assets/img/icons/brands/windows.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin-frontend') }}/assets/img/icons/brands/mac.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin-frontend') }}/assets/img/icons/brands/ubuntu.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin-frontend') }}/assets/img/icons/brands/cent.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin-frontend') }}/assets/img/icons/brands/linux.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin-frontend') }}/assets/img/icons/brands/fedora.png"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin-frontend') }}/assets/img/icons/brands/vivaldi-os.png"
                                                        alt="Vivaldi" height="24" class="me-2" />
                                                    <span>Vivaldi</span>
                                                </div>
                                            </td>
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin-frontend') }}/assets/svg/flags/us.svg"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin-frontend') }}/assets/svg/flags/br.svg"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin-frontend') }}/assets/svg/flags/in.svg"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin-frontend') }}/assets/svg/flags/au.svg"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin-frontend') }}/assets/svg/flags/de.svg"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin-frontend') }}/assets/svg/flags/fr.svg"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin-frontend') }}/assets/svg/flags/pt.svg"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="{{ asset('admin-frontend') }}/assets/svg/flags/cn.svg"
